...
<style>
	...
	@media (max-width:980px){#wpadminbar{display:none!important}.topbar{display:none!important}.mobile-bottom-nav-wrapper,.mobile-bottom-nav{display:none!important;visibility:hidden!important;opacity:0!important;pointer-events:none!important}}
	@media (max-width:640px){.topbar{display:none!important}.topbar-inner{min-height:0;padding:0}.topbar-left,.topbar-desktop-contact{display:none}.topbar-right{width:100%;justify-content:flex-end}.topbar-mobile-social,.topbar-mobile-lang{display:none!important}.categories-strip-inner{padding:8px 0;gap:6px}.category-strip-group{gap:5px;padding-inline-end:5px}.category-strip-chip{min-height:32px;padding:0 10px;font-size:12px}}
